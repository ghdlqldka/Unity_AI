...
namespace Unity.MLAgentsExamples
{
    ...
    public class ModelOverrider : MonoBehaviour
    {
        ...
        Dictionary<string, UnityEngine.Object> m_CachedModels = new Dictionary<string, UnityEngine.Object>();
        ...
        // ModelAsset 대신 UnityEngine.Object 사용
        public UnityEngine.Object GetModelForBehaviorName(string behaviorName)
        {
        ...
        // ModelAsset 대신 UnityEngine.Object 반환
        UnityEngine.Object LoadSentisModel(byte[] rawModel)
        {
            // ModelAsset 생성 코드를 주석 처리하고 더미 객체 반환
            ...
            Debug.LogWarning("Model loading is disabled - Unity.InferenceEngine not available");
            return ScriptableObject.CreateInstance<ScriptableObject>(); // 더미 객체 반환
        }
        ...
        void OverrideModel()
        {
            ...
            UnityEngine.Object ModelAsset = null;
            try
            {
            ...
            else
            {
                ...
                try
                {
                    ...
                    Debug.Log($"Model override set: {GetOverrideBehaviorName(OriginalBehaviorName)}");
                    overrideOk = true;
                }
                catch (Exception e)
                {
